...
public class SimplexNoise3D {
    ...
    protected final short[] shorts, permutations, permsModulus;
    ...
    private short[] getShortsRandomized(int range) {
    ...
    private short[] shuffle(short[] shorts) {
    ...
    public double getNoise(double x, double y, double z) {
        double corner0 = 0.0, corner1 = 0.0,
            corner2 = 0.0, corner3 = 0.0;
