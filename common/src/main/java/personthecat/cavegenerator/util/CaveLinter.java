...
public class CaveLinter extends SyntaxLinter {
    ...
    private static final Highlighter[] HIGHLIGHTERS = {
        ...
        new RegexHighlighter(CALL, color(ChatFormatting.GOLD).applyFormat(ChatFormatting.UNDERLINE)),
        new RegexHighlighter(REFERENCE, color(ChatFormatting.DARK_PURPLE).applyFormat(ChatFormatting.UNDERLINE)),
        new RegexHighlighter(ARGUMENT, color(ChatFormatting.DARK_GREEN).applyFormat(ChatFormatting.UNDERLINE)),
