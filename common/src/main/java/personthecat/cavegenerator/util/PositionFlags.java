...
public class PositionFlags {
     ...
     */
    public void forEach(final PositionConsumer f) {
     ...
     */
    public void filter(final PositionPredicate predicate) {
        final int end = index;
        index = 0;
        for (int i = 0; i < end; i++) {
            final int data = positions[i];
     ...
     */
    public boolean anyMatches(final PositionPredicate predicate) {
        for (int i = 0; i < index; i++) {
            final int data = positions[i];
